	...
	<body>
		<div class="form-login">
			<?php
                ...
                $userid = $_GET['userID'];
                // write sequence to query the Staff table to get the student name, if it is not done in the first script..
                echo '<h1>Welcome ' . $userid . ' to the Staff area of the Bursary Request System</h1>';
			?>
